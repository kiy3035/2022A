...
$(document).ready(function(){
	...
	$.ajax({
		...
		success : function(chk){ // 가입자 -> 탈퇴출력, 미가입자 -> 가입출력
			if(chk==0){
				var plz =  '<button class="btn btn-primary" onclick="myFunction()">　가입　</button>'
				$('#show').html( plz );
			} else {
				var plz =  '<button class="btn btn-primary" onclick="myFunction2()">　탈퇴　</button>'
			   var board  =  '<li><a href="/Pds/List?menu_idx=1&nowpage=1&pagecount=10&pagegrpnum=1&moim_idx=${moimVo.moim_idx}">자유 게시판</a></li>'
				   board +=  '<li><a href="/Pds/Album?moim_idx=${moimVo.moim_idx}" >사진첩</a></li>'
				   board +=  '<li><a href="/Pds/hi?moim_idx=${moimVo.moim_idx}" >가입인사 게시판</a></li>'
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card mb-4">
                        ...
                        <!-- 
                         ...
                         -->
                            <h3 class="card-title">저희 모임에 오신것을 환영합니다</h3>
                            <h3 class="card-title">동아리장 : ${ moimVo.user_name }</h3>
